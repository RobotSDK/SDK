...
public:
    ...
    bool estimateObjectState(int objectID, StateType & objectState, float & normalizer)
    {
    ...
    std::vector<int> estimateObjectState(std::vector<StateType> & objectsState, std::vector<float> & normalizer)
    {
