...
#define UNCERTAINTHRESH_ANG DEG2RAD(10)
...
struct StateConstrain
{
    ...
    double amin=DEG2RAD(-30),amax=DEG2RAD(30);
    double vmin=-10,vmax=30;
    double kmin=-0.1,kmax=0.1;
...
struct ObjectStateOffset
{
    ...
    double aoff=DEG2RAD(30),aprec=DEG2RAD(1),azoom=1;
    double voff=20,vprec=1,vzoom=1;
    double koff=0.1,kprec=0.001,kzoom=1;
